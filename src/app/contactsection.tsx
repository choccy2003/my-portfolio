...
const contactSection = ()=>{
   ...
   <div className="mb-60 mt-96 max-sm:mt-24 max-sm:mb-24">
    ...
    <div className="text-5xl font-bold mt-5 max-sm:text-4xl" style={{color:"#9ca2c2"}}>
        ...
        I am currently looking for new opportunities and open to freelance work or job offers. My inbox is always open, so whether you have a project in mind or just want to say hi, you can contact me.
        </div>
